...
*/
var _svgPathExp = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, _numbersExp = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, _scientific = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, _selectorExp$1 = /(^[#\.][a-z]|[a-y][a-z])/i, _DEG2RAD = Math.PI / 180;
180 / Math.PI;
var _sin$1 = Math.sin, _cos$1 = Math.cos, _abs = Math.abs, _sqrt$1 = Math.sqrt, _atan2$1 = Math.atan2, _largeNum = 1e8, _isString = function _isString(value) {
...
var gsap, _toArray, _lastLinkedAnchor, _coreInitted, PluginClass, _reverting, _getGSAP = function _getGSAP() {
	return gsap || typeof window !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap;
}, _isFunction = function _isFunction(value) {
	return typeof value === "function";
}, _atan2 = Math.atan2, _cos = Math.cos, _sin = Math.sin, _sqrt = Math.sqrt, _PI = Math.PI, _2PI = _PI * 2, _angleMin = _PI * .3, _angleMax = _PI * .7, _bigNum = 0x56bc75e2d63100000, _numExp = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/gi, _selectorExp = /(^[#.][a-z]|[a-y][a-z])/i, _commands = /[achlmqstvz]/i, _log = function _log(message) {
